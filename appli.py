...
if submit:
	...
	st.sidebar.success(f"Perte enregistrée : {cout} FCFA")
...
if not df.empty:
	...
	with col2:
		...
		fig_pie=px.pie(df,names="Type",values="Cout_Estime",title="Repartition des pertes (%)")
	...
	st.info("Aucune donnée disponible. Utilisez le formulaire à gauche pour commencer.")
